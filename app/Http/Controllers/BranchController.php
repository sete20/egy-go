...
class BranchController extends Controller
{
    ...
    {
        $governments = State::where('country_id', 65)->get();
        return view('backend.branchs.create', get_defined_vars());
    }
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'Branch.government_id' => 'required|exists:states,id',
        ]);
        try {
            DB::beginTransaction();
            $model = new Branch();
    ...
    public function edit($id)
    {
        ...
        if ($branch != null) {
            ...
            return view('backend.branchs.edit', compact('branch', 'governments'));
        }
        abort(404);
    }
