...
@if ($addon != null)
    @if($addon->activated)
        ...
        @if( in_array($user_type,['admin','branch']) || in_array('1106', json_decode(Auth::user()->staff->role->permissions ?? "[]")))
           ...
           <li class="menu-item {{ areActiveRoutes(['branch.due'])}}" aria-haspopup="true">
                            <a href="{{ route('branch.due') }}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot" style="font-size: 10px;"></i>
                                <span class="menu-text">{{translate('المبالغ المستحقة عل الفروع')}}</span>
                            </a>
                        </li>
                        <li class="menu-item {{ areActiveRoutes(['branch.index'])}}" aria-haspopup="true">
                       <a href="{{ route('branch.index') }}" class="menu-link">
                               <i class="menu-bullet menu-bullet-dot" style="font-size: 10px;"></i>
                           <span class="menu-text">{{translate('عمولات الـفروع')}}</span>
                       </a>
                        </li>
                        @endif
          <li class="menu-item {{ areActiveRoutes(['captain.index'])}}" aria-haspopup="true">
                            <a href="{{ route('captain.index') }}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot" style="font-size: 10px;"></i>
                                <span class="menu-text">{{translate('عمولات الكباتن')}}</span>
                            </a>
                        </li>

                        <li class="menu-item {{ areActiveRoutes(['client.supply.index'])}}" aria-haspopup="true">
                            <a href="{{ route('client.supply.index') }}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot" style="font-size: 10px;"></i>
                                <span class="menu-text">{{translate(' طلبات توريد العملاء')}}</span>
                            </a>
                        </li>
...
@if ($addon != null)
   ...
   <li class="menu-item {{ areActiveRoutes(['price.index'])}}" aria-haspopup="true">
                            <a href="{{ route('price.index') }}" class="menu-link">
                                <i class="menu-bullet menu-bullet-dot">
                                    <span></span>
                                </i>
                                <span class="menu-text">{{translate('اسعـار المنـاطق')}}</span>
                            </a>
                        </li>
