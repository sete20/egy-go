            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a href="#" class="text-muted">{{ translate('View Customer') }}</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                        ...
                        <div class="d-flex flex-wrap justify-content-between mt-1">
                            <div class="d-flex flex-column flex-grow-1 pr-8">
                                <div class="d-flex flex-wrap mb-4">
                                    ...
                                    <a href="#" class="text-dark-50 text-hover-primary font-weight-bold mr-lg-8 mr-5 mb-lg-0 mb-2">
                                    <i class="la la-money-check mr-2 font-size-lg"></i><span class="font-weight-boldest text-uppercase">{{translate('Pickup Cost')}}:</span> {{format_price($client->pickup_cost)}}</a>
                                    <a href="#" class="text-dark-50 text-hover-primary font-weight-bold">
                                    <i class="la la-money-check mr-2 font-size-lg"></i><span class="font-weight-boldest text-uppercase">{{translate('Supply Cost')}}:</span> {{format_price($client->supply_cost)}}</a>
                                </div>
                            </div>
                        </div>
                        <!--end::Content-->
                ...
                <div class="d-flex align-items-center flex-wrap mt-8">
                    ...
                    <div class="d-flex align-items-center flex-lg-fill mr-5 mb-2">
                        ...
                        <div class="d-flex flex-column text-dark-75">
                            ...
                            <span class="font-weight-bolder font-size-h5">{{format_price($client_tran)}}</span>
                        </div>
                    </div>
                    <!--end::Item-->
                    <!--begin::Item-->
