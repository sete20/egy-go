                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="{{translate('رقم الهاتف الشخصي')}}" name="Client[personal_phone]">
                        </div>
                    </div>
                              <div class="col-md-3">
                        <div class="form-group">
                            <label>{{translate('رقم الهاتف الارضي')}}:</label>
                            <input type="text" class="form-control" placeholder="{{translate('رقم الهاتف الارضي')}}" name="Client[landline_number]">
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="form-group" id="kt_repeater_1">
                    <div data-repeater-list="address">
                        ...
                        <div data-repeater-item class="data-repeater-item-count">
                            ...
                            <input type="text" class="form-control" placeholder="{{translate('العنوان')}}" required name="Client[address]">
