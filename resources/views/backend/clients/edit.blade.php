        ...
        <form class="form-horizontal" action="{{ route('admin.clients.update',['client'=>$client->id]) }}" id="kt_form_1" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="{{translate('Here')}}" value="{{$client->responsible_mobile}}" name="Client[responsible_mobile]">
                                                                  ...
                                                                  <div class="col-md-3">
                        <div class="form-group">
                            <label>{{translate('رقم الهاتف الشخصي')}}:</label>
                            <input type="number" minlength="11"  onblur="checkValue(this)"  class="form-control" value="{{ $client->personal_phone ?? "" }}" placeholder="{{translate('رقم الهاتف الشخصي')}}" name="Client[personal_phone]">
                        </div>
                    </div>
                              <div class="col-md-3">
                        <div class="form-group">
                            <label>{{translate('رقم الهاتف الارضي')}}:</label>
                            <input type="text" class="form-control"value="{{ $client->landline_number ?? ""}}" placeholder="{{translate('رقم الهاتف الارضي')}}" name="Client[landline_number]">
                        </div>
                    </div>
                    </div>
                ...
                <div class="mb-0 text-right form-group">
                    <button type="submit" id="sendForm" class="btn btn-sm btn-primary">{{translate('Save')}}</button>
                </div>
            </div>
        </form>
