    ...
    <div class="card">
        ...
        <form class="form-horizontal" action="{{ route('admin.captains.update',['captain'=>$captain->id]) }}" id="kt_form_1" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
             ...
             <div class="col-md-4">
                        <div class="form-group">
                            <label>{{translate('العمولة بكل اوردر')}}:</label>
                            <input type="number" class="form-control" placeholder="{{translate('العمولة بكل اوردر')}}" value="{{$captain->commission}}" name="Captain[commission]">
                        </div>
                    </div>
                </div>
