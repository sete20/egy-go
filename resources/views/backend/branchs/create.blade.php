...
@section('content')
    ...
    <div class="mx-auto col-lg-12">
        <div class="card">
            ...
            <form class="form-horizontal" action="{{ route('admin.branchs.store') }}" id="kt_form_1" method="POST"
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" id="name" class="form-control" placeholder="{{ translate('Branch Name') }}"
                            name="Branch[name]">
                    </div>
                    <div class="form-group">
                        ...
                        <input id="email-field" type="text" class="form-control" placeholder="{{ translate('Email') }}"
                            name="Branch[email]">
                                 ...
                                 <div class="form-group">
                            <label>{{translate('العمولة لكل اوردر تم توصيله')}}:</label>
                            <input type="number" class="form-control" placeholder="{{translate('العمولة لكل اوردر تم توصيله')}}" name="Branch[commission]">
                        </div>
                    <div class="form-group">
                        <label>{{ translate('government') }}:</label>
                        <select id="government-field" name="Branch[government_id]" class="form-control" id=""
                            name="Branch[government_id]">
                            @forelse ($governments as $government)
                                <option value="{{ $government->id }}">{{ $government->name }}</option>
                            @empty
                                <option value="" disabled>there is no governments exists </option>
                            @endforelse
                        </select>
                    </div>
