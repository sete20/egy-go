        ...
        <div class="card">
            ...
            <form class="form-horizontal" action="{{ route('admin.branchs.update', ['branch' => $branch->id]) }}"
               ...
               <div class="form-group">
                            ...
                            <input type="number" class="form-control" value="{{ $branch->commission }}"" placeholder="{{translate('العمولة لكل اوردر تم توصيله')}}" name="Branch[commission]">
                        </div>
                    <div class="form-group">
                        ...
                        <select id="government-field" name="Branch[government_id]" class="form-control" id=""
                            ...
                            @forelse ($governments as $government)
                                ...
                                <option value="{{ $government->id }}"
                                    {{ $government->id == $branch->government_id ?? 'selected' }}>
