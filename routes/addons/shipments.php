...
use App\Http\Controllers\SupplyShipmentController;
...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'user_role:admin|staff']], function(){
    Route::get('supply/shipment/{shipment}', 'SupplyShipmentController')->name('admin.shipment.supply');
...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'user_role:admin|staff|customer|branch']], function(){
    ...
    Route::delete('shipments/delete/{shipment}', 'ShipmentController@destory')->name('admin.shipments.delete');
