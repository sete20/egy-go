...
Route::post('/pickup/order', 'PickupController')->name('pickup.order.client');
Route::post('/supply/order', 'ClientDueController')->name('supply.order.client');
...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'user_role:admin|staff']], function(){
    ...
    Route::resource('state/price', StatePriceController::class);
